    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          {/* Choose Launch Format Button - Always show when no full plan */}
          {!hasFullPlan && (
            <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl shadow-lg border-2 border-purple-300 p-8 text-center mt-6">
              ...
              <button
                onClick={() => setShowLaunchPlanner(true)}
        ...
        {/* Launch Planner Modal */}
        {showLaunchPlanner && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 max-h-[90vh] overflow-y-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Choose Your Launch Format</h2>
              <p className="text-gray-600 mb-6">
